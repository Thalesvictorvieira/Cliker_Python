...
CLICK_SOUND_PATH = os.path.join(BASE_DIR, "../Src/assets/sounds/Click.wav")
MUSIC_PATH = os.path.join(BASE_DIR, "../Src/assets/sounds/Music.mp3")
BACKGROUND_IMAGE_PATH = os.path.join(BASE_DIR, "../Src/assets/icons/background.png")
CAMINHO_ARQUIVO = os.path.join(BASE_DIR, "../savegame.json")
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.Python_button.setIcon(QIcon("../Src/assets/icons/icon_python.png"))
